...
import { useCalendarUiStore, type EventDialogState } from "@/stores/calendarUiStore"
...
export function EventDialog() {
  const dialogState = useCalendarUiStore((s) => s.dialogState)
  const closeDialog = useCalendarUiStore((s) => s.closeDialog)
...
function EventDialogForm({ state }: { state: NonNullable<EventDialogState> }) {
  const closeDialog = useCalendarUiStore((s) => s.closeDialog)
